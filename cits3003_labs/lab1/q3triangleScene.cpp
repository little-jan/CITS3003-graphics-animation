...
#define WINDOW_TITLE "Lab1 Q3 Triangle Scene"

// Logic Constants
const int NumTriangles = 3;  // 3^5
...
void init() {
    ...
    triangle(glm::vec2(-0.5, -0.5), glm::vec2(0.0, 0.0), glm::vec2(0.5, -0.5));
    triangle(glm::vec2(-0.8, 0.8), glm::vec2(-0.6, 0.5), glm::vec2(-0.4, 0.8));
    triangle(glm::vec2(0.8, 0.8), glm::vec2(0.6, 0.5), glm::vec2(0.4, 0.8));
